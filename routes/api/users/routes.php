...
use App\Http\Controllers\Api\User\{All, AssociateUserCompany, Show, Store, ToggleUserCompanies, Update, Delete};
...
Route::post('/users/associate', [AssociateUserCompany::class, '__invoke']);
